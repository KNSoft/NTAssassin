...
#include "Include\NTAssassin_Base.h"
...
#define SetLastError WIE_SetLastError
#define GetLastError WIE_GetLastError
#define memset(Destination, Fill, Length) RtlFillMemory(Destination, Length, Fill) 

#define GetModuleHandleW(NULL) CURRENT_IMAGE_BASE
...
EXTERN_C ULONG WINAPI DetourGetModuleSize(_In_opt_ HMODULE hModule)
{
    ...
    return ((PIMAGE_NT_HEADERS)Add2Ptr(pDosHeader, pDosHeader->e_lfanew))->OptionalHeader.SizeOfImage;
}

#pragma warning(disable: 26495)
#include "3rdParty\Source\Detours\detours.cpp"
#include "3rdParty\Source\Detours\disasm.cpp"
