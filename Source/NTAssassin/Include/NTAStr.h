...
NTA_API SIZE_T NTAPI Str_LenW(PCWSTR String);
NTA_API SIZE_T NTAPI Str_LenA(PCSTR String);
...
_Success_(return >= 0) INT CDECL Str_VPrintfExW(_Out_writes_z_(DestCchSize) PWSTR Dest, _In_ SIZE_T DestCchSize, _In_z_ _Printf_format_string_ PCWSTR Format, _In_ va_list ArgList);
_Success_(return >= 0) INT CDECL Str_VPrintfExA(_Out_writes_z_(DestCchSize) PSTR Dest, _In_ SIZE_T DestCchSize, _In_z_ _Printf_format_string_ PCSTR Format, _In_ va_list ArgList);
